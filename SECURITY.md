...
repository that meets [Microsoft's definition of a security vulnerability][def],
...
Response Center PGP Key page](https://www.microsoft.com/en-us/msrc/pgp-key-msrc).
...
Microsoft follows the principle of [Coordinated Vulnerability Disclosure][cvd].

[def]: https://aka.ms/security.md/definition
[cvd]: https://aka.ms/security.md/cvd
